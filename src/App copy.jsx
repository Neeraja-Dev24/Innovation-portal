...
const ReviewerDashboard = lazy(() =>
  import("./Components/ReviewerDashboard/ReviewerDashboard")
);
...
const ApprovedIdeas = lazy(() =>
  import("./Components/EmployeeDashboard/ApprovedIdeas/ApprovedIdeas")
);
const ExistingIdeas = lazy(() =>
  import("./Components/EmployeeDashboard/ExistingIdeas/ExistingIdeas")
);
const SubmitIdeas = lazy(() =>
  import("./Components/EmployeeDashboard/SubmitIdeas/SubmitIdeas")
);
const PendingReviews = lazy(() =>
  import("./Components/ReviewerDashboard/PendingReviews/PendingReviews")
);
const ReviewDetailPage = lazy(() =>
  import("./Components/Pages/ReviewDetailPage")
);
