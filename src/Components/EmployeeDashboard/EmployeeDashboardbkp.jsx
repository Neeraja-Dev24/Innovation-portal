...
import { UploadOutlined,DeleteOutlined,EyeOutlined,LogoutOutlined } from '@ant-design/icons';
...
const EmployeeDashboard = () => {
  ...
  return (
    ...
    <Layout className="site-layout">
      <Sider className='inno-sider'>
        <Title level={3} onClick={()=>{}}>Welcome, {loggedInUser?.name} !</Title>
        <Title level={4} onClick={()=>{}}>Existing Ideas</Title>
        <Title level={4} onClick={()=>{}}>Submit Ideas</Title>
        <Title level={4} onClick={()=>{}}>Logout</Title>
      </Sider>
